/*
Copyright (c) 2011 ayanamist (http://twitter.com/gh05tw01f)
This work is based on:
Javascript QR Encoder(http://zdez.org/qrenc3.html), Copyright 2010, tz@execpc.com, released under GPLv3
*/

function doQR(el, url, width, height) {
...
// add in final mask/ecclevel bytes
    ...
    return [qrframe, width];
  }

  var qrc = el.getContext('2d');
